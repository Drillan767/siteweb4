...
Route.group(() => {
  ...
  Route.get('categories', 'TagController.allCategories')
  Route.get('category', 'TagController.showCategory')
  Route.post('category', 'TagController.storeCategory').middleware('auth')
  Route.post('category/:id', 'TagController.updateCategory').middleware('auth')
  Route.delete('category', 'TagController.deleteCategory').middleware('auth')
